...
optional arguments:
    ...
    -m, --min_kmer_prop
                        Minimum proportion of kmers required [0.6]
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--min_kmer_prop", type=float, help="Minimum proportion of mismatched kmers allowed [default=0.6]", nargs='?', default=0.6)
